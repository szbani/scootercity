...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main id="pageContent">
            ...
            <form action="query/U_markak.php" id="form" method="POST" autocomplete="off" enctype="multipart/form-data">
                <div class="modal fade" id="modal" tabindex="-1" aria-labelledby="uploadModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 id="modalTitle">Márka felvétele</h4>
                                <i class="fa-solid fa-pen-to-square"></i>
                            </div>
                            <div class="modal-body">
                                <div class="row row-cols-1 g-3">
                                    <div class="col">
                                        <label for="inputNev" class="form-label">Márka neve:</label>
                                        <input class="form-control" id="inputNev" type="text" name="nev" required/>
                                    </div>
                                    <div class="col">
                                        <label class="form-label" for="fileUpload">Márka Képe</label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="submit" class="btn btn-primary" id="modalSubmit" name="upload">Feltöltés
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <form id="delete">
                <div class=" modal fade" id="deleteModal" tabindex="-1" aria-labelledby="delModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="delModalLabel">Biztos törlöd ezt a Márkát?:<br>
