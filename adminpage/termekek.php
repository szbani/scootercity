...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main id="pageContent">
            ...
            <form action="query/U_termekek.php" id="form" method="POST" autocomplete="off"
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row g-3">
                                    <div class="col">
                                        ...
                                        <input class="form-control" id="inputNev" type="text" name="nev" placeholder="Termék neve" required/>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-8 mt-3">
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <input class="form-control" id="inputLearaz" type="number" name="learazas"/>
                                            </div>
                                            <div class="col-6">
                                                <label for="inputKategoria" class="form-label">Termék
                                                    kategóriája:</label>
                                    ...
                                    <div class="col-4">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-2 ps-0">
                                                <a class="add-menny" data-bs-toggle="tooltip" data-bs-placement="right"
                                ...
                                <div class="container form-control">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-1 ps-0">
                                            <a class="add-row" data-bs-toggle="tooltip" data-bs-placement="right"
                                               title="Sor hozzáadása">
                                                <i class="fa-solid fa-plus fa-2x"></i>
                                            </a>
                                        </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-3 text-center">
                                                    <fieldset class="form-group">
                                                        ...
                                                        <input type="file" hidden name="images[]" id="pro-image"
                                ...
                                <div class="row g-3">
                                    <div class="col">
                                        ...
                                        <textarea class="form-control" id="inputLeiras" name="leiras"
                                                  rows="4"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <div class="d-grid gap-2 col-6 mx-auto">
                                    ...
                                    <button type="submit" id="modalSubmit" class="btn btn-primary" name="upload">
                                        Feltöltés
                                    </button>
                                </div>
                            </div>
            ...
            <form id="reorder">
                <div class="modal fade" id="reorderModal" tabindex="-1" aria-labelledby="delModalLabel"
                     aria-hidden="true">
