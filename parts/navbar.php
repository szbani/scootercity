<nav class="navbar navbar-dark sticky-top navbar-expand-lg bg-nav">
    <div class="container">
        <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#sidebar" aria-controls="offcanvasResponsive">
        ...
        <div class="collapse navbar-collapse ms-3" id="navbarSupportedContent">
            <div class="row row-cols-1 row-cols-sm-1 row-cols-lg-2 w-100 gy-3">
                <div class="col col-lg-6">
                    <form class=" navbar-form lista h-100" role="search">
                        <div class="input-group h-100">
                            <input class="form-control" id="search" type="search" placeholder="Keresés"
                                   aria-label="Search" autocomplete="off">
                            <button type="submit" id="submit" class="input-group-text btn-success px-4"><i
                ...
                <div class="col col-lg-5">
                    <ul class="navbar-nav me-5 mb-lg-0 fs-5 justify-content-end ">
                        <li class="nav-item">
